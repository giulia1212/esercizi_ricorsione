...
def quicksort(sequenza):
    ...
    # caso ricorsivo
        ...
        # versione più compatta senza scrivere tutto il ciclo
        ...
        # 3. la soluzione è data da:
        # ordinare il vettore smaller + il vettore uguale a pivot + ordinare il vettore larger
